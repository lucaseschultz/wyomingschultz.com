...
const isValid = (str, int) => {
    if (!str.match(/[0-9_ivxlcdm.]/ig) || str.match(/[a-z]/i) && str.match(/[0-9]/)) {
        ...
        errText = '<p>Please enter a number under 8,000,000.<br>' +
            'To calculate larger numbers go to <a href="uncapped">' +
            'https://www.wyomingschultz.com/roman-numeral-calculator/uncapped</a></p>';
    }
    else {
        // No errors detected
        return true;
